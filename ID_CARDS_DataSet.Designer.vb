...
Partial Public Class ID_CARDS_DataSet
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/ID_CARDS_DataSet.xsd"
    ...
    Partial Public Class ID_CARDSDataTable
        ...
        Public Overloads Function AddID_CARDSRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {IDNumber, LastName, FirstName, MI, DOB, SSN, Address, H_Address, H_City, H_ZIP, IssueDate, ExpirationDate, Photo, Hair, Eyes, BloodType, Rank, PayGrade, Height, Weight, DLData, Sex, SerialNumber, CACPDF, AAMVAPDF, AAMVAMAG, AAMVACode39, CACCode39}
        ...
        Private Sub InitClass()
            ...
            Me.columnH_Address.MaxLength = 50
            ...
            Me.columnCACPDF.MaxLength = 255
            Me.columnAAMVAPDF.MaxLength = 2048
            Me.columnAAMVAMAG.MaxLength = 2048
            Me.columnAAMVACode39.MaxLength = 255
            Me.columnCACCode39.MaxLength = 255
        End Sub
    ...
    Partial Public Class ID_CARDSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `ID_CARDS` (`IDNumber`, `LastName`, `FirstName`, `MI`, `DOB`, `SSN`, "& _ 
                ...
                ", `Sex`, `SerialNumber`, `CACPDF`, `AAMVAPDF`, `AAMVAMAG`, `AAMVACode39`, `CACCo"& _ 
                "de39`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,"& _ 
                " ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("CACPDF", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "CACPDF", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("AAMVAPDF", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "AAMVAPDF", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("AAMVAMAG", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "AAMVAMAG", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("AAMVACode39", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "AAMVACode39", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("CACCode39", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "CACCode39", Global.System.Data.DataRowVersion.Current, false, Nothing))
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Sub InitConnection()
            Me._connection = New Global.System.Data.OleDb.OleDbConnection
            Me._connection.ConnectionString = Global.CSMR_DB_Convert.My.MySettings.Default.ID_CARDS_ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT IDNumber, LastName, FirstName, MI, DOB, SSN, Address, H_Address, H_City, H"& _ 
                ...
                "eight, Weight, DLData, Sex, SerialNumber, CACPDF, AAMVAPDF, AAMVAMAG, AAMVACode3"& _ 
                "9, CACCode39 FROM ID_CARDS"
        ...
        Public Overloads Overridable Function Insert( _
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(23).Value = CType(CACPDF,String)
            End If
            If (AAMVAPDF Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(24).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(24).Value = CType(AAMVAPDF,String)
            End If
            If (AAMVAMAG Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(25).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(25).Value = CType(AAMVAMAG,String)
            End If
            If (AAMVACode39 Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(26).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(26).Value = CType(AAMVACode39,String)
            End If
            If (CACCode39 Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(27).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(27).Value = CType(CACCode39,String)
            End If
